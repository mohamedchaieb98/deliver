...
def downgrade():
    ...
    op.create_index(
        "ix_inventories_product_id", "inventories", ["product_id"], unique=False
    )
    op.create_index(
        "ix_inventories_is_active", "inventories", ["is_active"], unique=False
    )
    ...
    op.create_index(
        "ix_supplier_products_id", "supplier_products", ["id"], unique=False
    )
    op.create_table(
        "routes",
        sa.Column("id", sa.VARCHAR(length=36), nullable=False),
    ...
    op.create_index(
        "ix_order_items_supplier_order_id",
        "order_items",
        ["supplier_order_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "outstanding_balance", sa.NUMERIC(precision=10, scale=2), nullable=True
        ),
        sa.Column("is_active", sa.BOOLEAN(), nullable=True),
    ...
    op.create_index(
        "ix_inventory_transactions_id", "inventory_transactions", ["id"], unique=False
    )
    op.create_table(
        "deliverers",
        sa.Column("id", sa.VARCHAR(length=36), nullable=False),
    ...
    op.create_index(
        "ix_deliverers_territory", "deliverers", ["territory"], unique=False
    )
    op.create_index(
        "ix_deliverers_is_available", "deliverers", ["is_available"], unique=False
    )
    op.create_index("ix_deliverers_id", "deliverers", ["id"], unique=False)
    op.create_index(
        "ix_deliverers_employee_id", "deliverers", ["employee_id"], unique=False
    )
    # ### end Alembic commands ###
