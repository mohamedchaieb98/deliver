...
def test_endpoint(method, endpoint, data=None, params=None, description="", expect_status=None):
...
def test_deliverers_api():
    ...
    response = test_endpoint("POST", "/deliverers", data=deliverer_data, 
                           description="Create new deliverer", expect_status=201)
    ...
    if deliverer_id:
        ...
        test_endpoint("GET", f"/deliverers/{deliverer_id}", 
                     description="Get deliverer by ID")
        
        # PUT /deliverers/{id} - Update
        update_data = {"name": "Updated Test Deliverer", "is_available": False}
        test_endpoint("PUT", f"/deliverers/{deliverer_id}", data=update_data,
                     description="Update deliverer")
        
        # DELETE /deliverers/{id} - Delete
        test_endpoint("DELETE", f"/deliverers/{deliverer_id}",
                     description="Delete deliverer")
...
def test_clients_api():
    ...
    response = test_endpoint("POST", "/clients", data=client_data,
                           description="Create new client", expect_status=201)
    ...
    if client_id:
        ...
        test_endpoint("PUT", f"/clients/{client_id}", data=update_data,
...
def test_expenses_api():
    ...
    response = test_endpoint("POST", "/expenses", data=expense_data,
                           description="Create new expense", expect_status=201)
    ...
    if expense_id:
        ...
        test_endpoint("PUT", f"/expenses/{expense_id}", data=update_data,
...
def test_products_api():
    ...
    response = test_endpoint("POST", "/products", data=product_data,
                           description="Create new product", expect_status=201)
    ...
    if product_id:
        ...
        test_endpoint("PUT", f"/products/{product_id}", data=update_data,
...
def test_suppliers_api():
    ...
    response = test_endpoint("POST", "/suppliers", data=supplier_data,
                           description="Create new supplier", expect_status=201)
    ...
    if supplier_id:
        ...
        test_endpoint("GET", f"/suppliers/{supplier_id}", description="Get supplier by ID")
        
        # PUT /suppliers/{id} - Update
        update_data = {"name": "Updated Test Supplier", "contact_person": "John Updated"}
        test_endpoint("PUT", f"/suppliers/{supplier_id}", data=update_data,
                     description="Update supplier")
        
        # DELETE /suppliers/{id} - Delete
        test_endpoint("DELETE", f"/suppliers/{supplier_id}", description="Delete supplier")
...
def test_resellers_api():
    ...
    response = test_endpoint("POST", "/resellers", data=reseller_data,
                           description="Create new reseller", expect_status=201)
    ...
    if reseller_id:
        ...
        test_endpoint("GET", f"/resellers/{reseller_id}", description="Get reseller by ID")
        
        # PUT /resellers/{id} - Update
        update_data = {"business_name": "Updated Test Reseller", "contact_person": "Jane Updated"}
        test_endpoint("PUT", f"/resellers/{reseller_id}", data=update_data,
                     description="Update reseller")
        
        # DELETE /resellers/{id} - Delete
        test_endpoint("DELETE", f"/resellers/{reseller_id}", description="Delete reseller")
...
def test_orders_api():
    ...
    # First create a reseller for the order
    reseller_data = get_test_data()["reseller"]
    reseller_data["business_name"] = "Order Test Reseller"
    reseller_response = test_endpoint("POST", "/resellers", data=reseller_data,
                                    description="Create reseller for order test", expect_status=201)
    
    reseller_id = None
    if reseller_response:
        try:
            reseller_id = reseller_response.json().get("id")
        except:
            pass
    ...
    if reseller_id:
        ...
        order_data["reseller_id"] = reseller_id
        response = test_endpoint("POST", "/orders", data=order_data,
                               description="Create new order", expect_status=201)
        ...
        if order_id:
            ...
            test_endpoint("PUT", f"/orders/{order_id}", data=update_data,
